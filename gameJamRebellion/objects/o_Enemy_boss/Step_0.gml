...
if (hp == 1){
    sprite_index = s_enemy_boss_almost_die;
}

if state == "dead" {
	sprite_index = s_enemy_boss_die;
    if image_speed > 0{
...
/// @DnDVersion : 1
/// @DnDHash : 386E6CE7
/// @DnDArgument : "code" "/// @description ATTACK STATE$(13_10)$(13_10)if ((state == "attack") and (cooldown == false) && o_Player.state != "dead" && o_Player.state != "hit") {$(13_10)	hspeed = 0;$(13_10)    sprite_index = s_enemy_boss_attack;$(13_10)	o_Player.state = "hit";$(13_10)	o_Player.hp -= 1;$(13_10)	cooldown = true;$(13_10)	alarm[0] = 30;$(13_10)}"
...
/// @DnDVersion : 1
/// @DnDHash : 6DF69672
/// @DnDArgument : "code" "/// @description MOVE STATE$(13_10)$(13_10)if state == "move" {$(13_10)	$(13_10)    hspeed = choose(-2);$(13_10)}$(13_10)"
