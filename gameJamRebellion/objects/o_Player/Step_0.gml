...
/// @DnDVersion : 1
/// @DnDHash : 139F3948
/// @DnDArgument : "code" "/// @description DEAD STATE$(13_10)$(13_10)if (hp <= 0){$(13_10)    state = "dead";$(13_10)}$(13_10)$(13_10)if state == "dead" {$(13_10)    sprite_index = s_player_die;$(13_10)    $(13_10)    if image_speed > 0 {$(13_10)		if image_index > image_number -1 {$(13_10)			instance_destroy(); $(13_10)			instance_deactivate_all(1);$(13_10)			instance_activate_object(o_GameOver);$(13_10)			instance_activate_object(o_Rejouer);$(13_10)			instance_activate_object(o_Quit);$(13_10)		}$(13_10)    }$(13_10)	$(13_10)}"
